...
private:
    ...
    Q_PROPERTY(QString shostname READ shostname WRITE setShostname NOTIFY shostnameChanged)
    ...
    //added by ghazanfar - started
     Q_PROPERTY(bool isSubscriber READ isSubscriber WRITE setIsSubscriber NOTIFY isSubscriberChanged)
     //Q_PROPERTY(QString subTopic READ subTopic WRITE setSubTopic NOTIFY subTopicChanged)
     Q_PROPERTY(bool isPublisher READ isPublisher WRITE setIsPublisher NOTIFY isPublisherChanged)
     Q_PROPERTY(QString pubMessage READ pubMessage WRITE setPubMessage NOTIFY pubMessageChanged)
     Q_PROPERTY(quint16 pubInterval READ pubInterval WRITE setPubInterval NOTIFY pubIntervalChanged)
     //added by ghazanfar - end
public:
    ...
    bool requestPing();
     QString subtopic() const;
    QString shostname() const;
...
Q_SIGNALS:
    ...
    void shostnameChanged(QString shostname);
   ...
   void isSubscriberChanged(bool isSubscriber);
  //void subTopicChanged(QString subTopic);
   void isPublisherChanged(bool isPublisher);
   void pubMessageChanged(QString pubMessage);
   void pubIntervalChanged(quint16 pubInterval);

public Q_SLOTS:
     void setsubtopic(const QString &subtopic);
    void setShostname(const QString &shostname);
   ...
   //void setSubTopic(const QString &subTopic);
   void setIsPublisher( bool isPublisher);
   void setPubMessage(const QString &pubMessage);
  void setPubInterval( quint16 pubInterval);
