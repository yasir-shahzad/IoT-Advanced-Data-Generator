 ...
 *                                                                         *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#ifndef OBJFRMNEWDEVICETEMPLATEVIEW_H
#define OBJFRMNEWDEVICETEMPLATEVIEW_H
#include<QString>

class objFrmNewDeviceTemplateView
{
public:
    objFrmNewDeviceTemplateView();
    int _id;
    QString deviceName;
    QString deviceDescription;
};

#endif // OBJFRMNEWDEVICETEMPLATEVIEW_H
